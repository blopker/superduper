          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                pinned: true,
                expandedHeight: 80,
                // These properties ensure consistent black background
                stretch: true,
                flexibleSpace: FlexibleSpaceBar(
                  // The background color ensures consistency when scrolling
                  ...
                  // Disable transparency when scrolling
                  stretchModes: const [],
                ),
              ),
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isScanning.value ?? false
                          ? const Color(0xff441DFC).withValues(alpha: .2)
                          : Colors.transparent,
